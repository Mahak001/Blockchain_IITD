/*Problem Statement 1: Basic Contact List Objective: Create a contract named 
ContactList that allows users to store and retrieve phone numbers associated with names. 
...
contract ContactList {
    ...
    function getContact() public view returns (string memory, string memory) {
        Contact memory newcontact=contacts[msg.sender]; //instance of struct Contact
